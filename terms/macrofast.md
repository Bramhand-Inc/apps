...
## Acknowledgement
This agreement is between you and Bramhand Inc. only, and not with Apple Inc. Bramhand Inc., not Apple, is solely responsible for MacroFast and its content. By using MacroFast, you acknowledge that you have reviewed the Apple Media Services Terms and Conditions.

## License
Bramhand Inc. grants you a personal, non-transferable, non-exclusive license to use MacroFast on any Apple-branded device that you own or control, as permitted by the Apple Media Services Terms and Conditions (Usage Rules). This license does not allow you to use MacroFast on any device you do not own or control. You may use MacroFast through Family Sharing or volume purchasing programs as permitted by Apple's Usage Rules.
...
## Warranty
Bramhand Inc. is solely responsible for any product warranties, whether express or implied by law, to the extent not effectively disclaimed. In the event MacroFast fails to conform to any applicable warranty, you may notify Apple, and Apple will refund the purchase price for MacroFast to you. To the maximum extent permitted by applicable law, Apple will have no other warranty obligation whatsoever with respect to MacroFast, and any other claims, losses, liabilities, damages, costs, or expenses attributable to any failure to conform to any warranty will be Bramhand Inc.'s sole responsibility.
...
- Calorie and macro targets are personal goals you configure — they are not prescribed by a dietitian or physician.
- Fasting zone labels are informational reference points, not clinical guidance.
...
In the event of any third-party claim that MacroFast or your possession and use of MacroFast infringes that third party's intellectual property rights, Bramhand Inc., not Apple, will be solely responsible for the investigation, defense, settlement and discharge of any such intellectual property infringement claim.

## Legal Compliance
You represent and warrant that: (i) you are not located in a country that is subject to a U.S. Government embargo, or that has been designated by the U.S. Government as a "terrorist supporting" country; and (ii) you are not listed on any U.S. Government list of prohibited or restricted parties.

## Third Party Terms
You must comply with applicable third-party terms of agreement when using MacroFast. For example, if you use MacroFast in connection with a data service, you must not violate that service's terms of use.
...
- **v1.2 (August 2026)** — Added fiber as a tracked macro (visible in meal summaries, day totals, and Add/Edit food forms). Barcode scanning now populates fiber from Open Food Facts. USDA food database updated with fiber values. Fiber is now written to Apple Health alongside calories, protein, carbs, and fat. "Ask your own AI" export copies a full nutrition, fasting, and glucose summary to clipboard for pasting into ChatGPT, Claude, Gemini, or any AI assistant. Trend charts now show the last N completed days plus today as a faded bar; averages exclude the in-progress current day. Long-press on any food entry in the History food log now shows a context menu: Log Again ×1/×2/×3, Edit, and Delete. Photo library picker fix. Calorie display now shows two decimal places for values over 1,000 (e.g. 1.63k).
